        ...
        <div className="px-8 pb-8 flex-1">
          <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
            <div className="px-5 py-3 border-b border-slate-100 dark:border-slate-800">
              <span className="text-sm text-slate-500">{filtered.length} prescriptions</span>
            </div>
                  ...
                  {filtered.map(rx => {
                    ...
                    return (
                      <tr key={rx.id} className="hover:bg-indigo-50/30 dark:hover:bg-slate-800/30 transition-colors group">
                        <td className="px-5 py-4">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-slate-400 mt-0.5">{rx.indication}</p>
                            </div>
                          </div>
                        </td>
                        <td className="px-5 py-4">
                        ...
                        <td className="px-5 py-4">
                          <p className="text-slate-700 dark:text-slate-300 text-xs">{rx.duration}</p>
                          <p className="text-xs text-slate-400">{rx.startDate}</p>
                        </td>
                        <td className="px-5 py-4">
                        ...
                        <td className="px-5 py-4">
                          ...
                          {rx.refillsRemaining === 0 && rx.status === 'Active' && (
                            <p className="text-xs text-amber-600 dark:text-amber-400 mt-1 flex items-center gap-1"><RefreshCw className="w-2.5 h-2.5" /> Refill needed</p>
                          )}
                        </td>
                        <td className="px-5 py-4">
                          {rx.dispensed ? (
                        ...
                        <td className="px-5 py-4">
                          <button className="opacity-0 group-hover:opacity-100 transition-opacity p-1.5 text-slate-400 hover:text-slate-600 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg">
