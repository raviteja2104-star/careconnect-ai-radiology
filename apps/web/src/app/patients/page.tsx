                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/60 text-xs uppercase tracking-wider text-slate-500">
                      {['Patient', 'MRN', 'Age/Gender', 'Blood', 'Status', 'Ward / Doctor', 'Last Visit', 'Diagnosis', ''].map(h => (
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                    {filtered.map((p, i) => {
                      ...
                      return (
                        <tr key={p.id} className="hover:bg-indigo-50/30 dark:hover:bg-slate-800/40 transition-colors group cursor-pointer">
